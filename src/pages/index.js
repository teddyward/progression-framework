    ...
    return (
      <Layout data={this.props.data}>
        <DescriptionView>
          ...
          <Description>
            <DescriptionText>
              This is where we keep the progression frameworks we use at Kevala.
            </DescriptionText>
            <DescriptionText>
            ...
            <DescriptionText>
              We&apos;ve put them here for everyone at Kevala (and anyone in the
              world!) to use.
            </DescriptionText>
            <DescriptionText>
            ...
            <DescriptionText>
              ...
              <a href="https://github.com/teddyward/progression-framework">
                <FontAwesomeIcon icon={faGithub} />{' '}
                @teddyward/progression-framework.
              </a>
            </DescriptionText>
            <DescriptionText>
